...
The v0.5 branch uses an offline learned ranker trained on SRIA authentication/topology features. The current analyst-output branch uses the RF depth-10 learned-ranker artifact:
...
This output is intended to support analyst review, not automated suppression or autonomous incident declaration.
